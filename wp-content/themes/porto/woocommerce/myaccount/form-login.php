...
<div class="u-columns row">
	...
	<?php endif; ?>
<?php endif; ?>
		<?php if( ( ! isset( $_GET['action'] ) && $_GET['action'] != 'register' ) || get_option( 'woocommerce_enable_myaccount_registration' ) === 'yes' ): ?>
				...
				<?php if ( get_option( 'woocommerce_enable_myaccount_registration' ) !== 'yes' ) : ?>
					<div class="row">
						<div class="col-sm-6">
							...
							<p><?php _e( 'By creating an account with our store, you will be able to move through the checkout process faster, store multiple shipping addresses, view and track your orders in your account and more.', 'woocommerce'); ?></p>
							<a class="btn btn-primary" href="<?php echo get_permalink( woocommerce_get_page_id( 'myaccount' ) ) . '?action=register'?>"><?php _e( 'Create an Account', 'woocommerce' ); ?></a>
						</div>
						<div class="col-sm-6">
				<?php endif; ?>
