        ...
        <div class="featured-box align-left">
            <div class="box-content">
                ...
                <form method="post" class="register">
					...
					<h2><?php _e( 'LOGIN INFORMATION', 'woocommerce' ); ?></h2>
                    ...
                    <div class="woocommerce-FormRow form-row clearfix">
						<p class="required pull-right"><?php _e( '* Required Fields', 'woocommerce' ); ?></p>
                    </div>
					
					<div class="woocommerce-FormRow form-row clearfix">
                        <?php wp_nonce_field( 'woocommerce-register', 'woocommerce-register-nonce' ); ?>
						<?php if( isset( $_SERVER['HTTP_REFERER'] ) && $_SERVER['HTTP_REFERER'] ): ?>
							<a href="<?php echo get_permalink( woocommerce_get_page_id( 'myaccount' ) ); ?>" class="pull-left"><i class="fa fa-angle-double-left"></i> <?php _e( 'Back', 'woocommerce' ); ?></a>
						<?php endif; ?>
                        <input type="submit" class="woocommerce-Button button pull-right" name="register" value="<?php esc_attr_e( 'Submit', 'woocommerce' ); ?>" />
                    </div>
